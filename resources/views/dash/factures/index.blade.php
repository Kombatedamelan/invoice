    ...
    <div class="table-responsive">
        <table class="invoice-table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions-group">
                                ...
                                <!-- Télécharger PDF -->
                                <a href="{{ route('factures.pdf', $facture->id) }}" class="btn-action download" title="Télécharger le PDF">
                ...
                @empty
                    <tr>
                        <td colspan="4" style="text-align: center; padding: 40px 20px; color: #5a6a7e;">
